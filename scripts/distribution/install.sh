...
#
# Env overrides:
#   OKSI_DOWNLOAD_BASE   Base URL for release assets (default: https://downloads.example.com/oksi-sw-licensing/releases/latest)
...
BASE_URL=${OKSI_DOWNLOAD_BASE:-"https://downloads.example.com/oksi-sw-licensing/releases/latest"}
