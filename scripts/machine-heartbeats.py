...
# Parse CLI arguments for Keygen credentials
parser = argparse.ArgumentParser(description='Maintain Keygen machine heartbeats.')
parser.add_argument('--license-key', required=True, help='Keygen license key')
